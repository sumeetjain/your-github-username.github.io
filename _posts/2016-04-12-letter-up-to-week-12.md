...
Today I spent most of the day working through figuring how to get the administrate and devise gems to play nice with eachother.  While I though I had most of it down I was stumped on how to actually create a logout link and style it in the same style as the buttons that already existed in administrate. All I code for an existing do was steal code and try to insert my own into it since Administrate hides their CSS files in some sort of vault on your computer when you download it. Theyre like basically inaccessible. Which is annoying. But I got it! I made that damn button look exactly like the other onese on the page and it logs you out and everything!
